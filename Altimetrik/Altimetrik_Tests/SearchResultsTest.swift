...
class SearchResultsTest: XCTestCase {
    ...
    func testDecodedSuccessfully() throws {
        ...
        let data = Data("{\"artistName\": \"Gameloft\",\"trackName\": \"Minion Rush\",\"collectionName\": \"Minion\",\"price\": 0.00,\"artworkUrl100\": \"https://is5-ssl.mzstatic.com/image/thumb/Purple124/v4/4e/6e/3b/4e6e3bfb-a6b9-b6dd-d30d-6d8136fc2f92/source/100x100bb.jpg\",\"releaseDate\": \"2013-06-13T07:00:00Z\"}".utf8)
